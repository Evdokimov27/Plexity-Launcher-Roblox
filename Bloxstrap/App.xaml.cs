...
namespace Plexity
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Plexity-QA";
#else
        ...
        public static void AssertWindowsOSVersion()
        {
            ...
            if (major < 7)
            {
                ...
                if (!LaunchSettings.QuietFlag.Active)
                    Frontend.ShowMessageBox("Your Windows Version is not supported with Plexity!", MessageBoxImage.Error);
        ...
        private void InitializeDiscordRPC()
        {
            ...
            if (Settings.Prop.PlexityRPCReal)
            {
		...
		protected override void OnStartup(StartupEventArgs e)
        {
            ...
            else
            {
                ...
                if (Settings?.Prop?.PlexityRPCReal == true)
                {
