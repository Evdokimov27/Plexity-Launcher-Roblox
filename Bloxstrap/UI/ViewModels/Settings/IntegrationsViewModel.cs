...
namespace Plexity.UI.ViewModels.Settings
{
    public class IntegrationsViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public bool PlexityEnabled
        {
            get => App.Settings.Prop.PlexityRPCReal;
            set => App.Settings.Prop.PlexityRPCReal = value;
        }
        ...
        {
            get => App.Settings.Prop.UseDiscordRichPresence || App.Settings.Prop.PlexityRPCReal;
            set
            {
