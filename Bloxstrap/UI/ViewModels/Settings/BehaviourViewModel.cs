...
namespace Plexity.UI.ViewModels.Settings
{
    public class BehaviourViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public bool CleanerPlexity
        {
            get => CleanerItems.Contains("PlexityLogs");
            set
            {
                if (value && !CleanerItems.Contains("PlexityLogs"))
                {
                    CleanerItems.Add("PlexityLogs");
                    UpdateCleanerItems();
                }
                else if (!value && CleanerItems.Contains("PlexityLogs"))
                {
                    CleanerItems.Remove("PlexityLogs");
                    UpdateCleanerItems();
                }
                OnPropertyChanged(nameof(CleanerPlexity));
            }
        }
    }
}
