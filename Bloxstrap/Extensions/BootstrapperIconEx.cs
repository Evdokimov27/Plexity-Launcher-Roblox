    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconPlexity;
            }

            return icon switch
            {
                BootstrapperIcon.IconPlexity => Properties.Resources.IconPlexity,
                ...
                _ => Properties.Resources.IconPlexity
            };
        }
    }
}
