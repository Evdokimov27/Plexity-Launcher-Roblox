...
namespace Plexity
{
    public class Bootstrapper
    {
        ...
        public async Task Run()
        {
            ...
            try
            {
                ...
                {
                    App.Logger.WriteLine(LOG_IDENT, "Plexity-Bootstrapper mutex exists, waiting...");
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Plexity instance running, aborting update check");
                return false;
            }
    ...
    string version = App.Version;
			...
			SetStatus(Strings.Bootstrapper_Status_UpgradingPlexity);
