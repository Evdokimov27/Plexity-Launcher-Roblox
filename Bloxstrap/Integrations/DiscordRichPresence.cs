...
using Plexity.Models.RobloxApi;
using DiscordRPC;

namespace Plexity.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        public void ProcessRPCMessage(Message message, bool implicitUpdate = true)
        {
            ...
            {
                Models.PlexityRPC.RichPresence? presenceData;

                try
                {
                    presenceData = message.Data.Deserialize<Models.PlexityRPC.RichPresence>();
                }
                catch (Exception)
                {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            // this is used for configuration from PlexityRPC
